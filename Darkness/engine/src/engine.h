...
// crystal.h is my primitive shape
#include "engine/entities/shapes/crystal.h"
// added my primitive shape
#include "engine/entities/shapes/vial.h"
// lamp.h is my primitive shape used for light.
#include "engine/entities/shapes/lamp.h"
